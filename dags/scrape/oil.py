...
class Oil(WorldStatistics):
    ...
    async def scrape_and_save(self):
        ...
        self.save_to_s3(oil_df.drop(columns=['#_x', '#_y', '#', 'World_Share_y']).rename(
            columns={'World_Share_x': "World_Share"}), self.bucket_name, "oil/world_oil.csv")
        ...
        for i, row in country_df.iterrows():
            ...
            if (
                ...
                if prod_oil_df is not None and not prod_oil_df.empty:
                    ...
                    self.save_to_s3(prod_oil_df, self.bucket_name,
                                    f"oil/country/{Country}.csv")
