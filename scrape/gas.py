...
class Gas(WorldStatistics):
    ...
    async def scrape_and_save(self):
        ...
        self.save_csv(world_gas_df, f"gas/world_gas.csv")
        ...
        self.save_csv(country_gas_df, f"gas/country_gas.csv")
    ...
    async def __process_country_gas_table(self, soup):
        ...
        for i, row in country_df.iterrows():
            ...
            if (
                ...
                self.save_csv(oil_country_df, f"gas/country/{Country}.csv")
